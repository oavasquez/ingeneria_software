  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="row">
        ...
        <!-- /.col -->
        <div class="col-md-9">
          <h2>&emsp;&emsp;Solicitud de Permiso por Matrimonio</h2>
          <form action="/my-handling-form-page" method="post">
              ...
              <div class="permiso">
                ...
                <br></br>
                <label for="tippCompromiso">&emsp;Tipo Compromiso:&emsp;</lable> <input type="text" name="tipCompromiso">
                <label for="hora">&emsp;Hora de Boda:&emsp;</label> <input type="time" name="hora" style="width:80px">
                <br></br>
                <label for="fecha:">&emsp;Fecha del Compromiso:&emsp;</label>  <input type="date" name="fecha1" style="width:180px">
              </div>
              <br></br>
              <div>
