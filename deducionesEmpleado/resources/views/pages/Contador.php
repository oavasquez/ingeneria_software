...
<head>
  ...
  <!-- Just for this page , i will use jTable to present the data -->

 
  <!-- Include one of jTable styles. -->
<link href="../dist/js/jtable/themes/metro/blue/jtable.min.css" rel="stylesheet" type="text/css" />
        ...
        <div class="col-md-12">
          <div class="box box-solid">
            <div class="box-header with-border">
              <h4 class="box-title">Sueldo de empleados</h4>
            </div>
            <div class="box-body">
              <!-- the events -->
              <div id="Sueldo_Empleados">
...
<!-- jQuery UI -->
<script src="../dist/js/jquery-ui/jquery-ui.min.js" type="text/javascript"></script>
<!-- Include jTable script file. -->
<script src="../dist/js/jtable/jquery.jtable.min.js" type="text/javascript"></script>
...
<script>
     $(document).ready(function () {
        $('#Sueldo_Empleados').jtable({
            title: 'Sueldo de Empleados',
