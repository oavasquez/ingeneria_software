  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="row">
        ...
        <!-- /.col -->
        <div class="col-md-9">
          <h2>&emsp;&emsp;Solicitud de Permiso por dia</h2>
          <form action="/my-handling-form-page" method="post">
              ...
              <br></br>
              <div class="permiso">
                <label for="tipoPermiso" size=10 >&emsp;Tipo de permiso solicitado:&emsp;</label>  <input type="text" name="tipoPermiso" style="width:250px">
                <br></br>
                <label for="fecha1:" size=10 >&emsp;Fecha del Permiso:&emsp;</label>  <input type="date" name="fecha1">
              </div>
              <br></br>
              <div>
