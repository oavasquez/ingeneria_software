  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="row">
        ...
        <!-- /.col -->
        <div class="col-md-9">
          <h2>&emsp;&emsp;Solicitud de Permiso por Incapacidad Medica</h2>
          <form action="/my-handling-form-page" method="post">
              ...
              <div class="permiso">
                ...
                <br></br>
                <label for="fecha1">&emsp;Fecha del Permiso:&emsp;</label>  <input type="date" name="fecha1">
                <label for="dias">&emsp;Dias a Faltar:&emsp;</label> <input type="number" style="width:70px">
              </div>
              <br></br>
              <div>
                <label for="excusa">&emsp;Excusa Medica: &emsp;</label> <img src="" width="100px" height="100px">
              </div>
              <br></br>
              <div>
                  <label for="msg">&emsp;Descripsion de la solicitud:</label>
                  <br></br>
                <label>&emsp;&emsp;&emsp;</label><textarea id="msg" style="width:500px" style="heigth:500px"></textarea>
              </div>
              <br></br>
              <div class="button">
